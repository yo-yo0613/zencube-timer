// scratch/test_sune_trace_direct.js
import fs from 'fs';
...
const c1 = new Cube3x3();
c1.applyScramble("R U R' U R U2 R'");
console.log("Scramble: Sune R U R' U R U2 R'");
console.log("Corners Trace:", traceCorners(c1).join(" "));
console.log("Edges Trace:", traceEdges(c1).join(" "));
